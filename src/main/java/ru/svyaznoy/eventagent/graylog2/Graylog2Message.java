...
public class Graylog2Message {
    ...
    public Graylog2Message() {
    }

    public Graylog2Message(String shortMessage, String fullMessage, long timestamp, String level) {
        this(shortMessage, fullMessage, timestamp, level, null, null);
    }

    public Graylog2Message(String shortMessage, String fullMessage, long timestamp, String level, String line, String file) {
    ...
    public String toJson() {
        ...
        for (String key : additonalFields.keySet()) {
            if (!ID_NAME.equals(key)) {
                if (    key.equals("Rows") ||
                        key.equals("RowsAffected") ||
                        key.equals("duration") ||
                        key.equals("level") ||
                        key.equals("position") ||
                        key.equals("dbpid")) {
                    try {
                        map.put("_" + key, Long.parseLong((String) additonalFields.get(key)));
                    } catch (NumberFormatException e) {
                        map.put("_" + key, -1L);
                    }
                }
    ...
    public Graylog2Message addField(String key, String value) {
        getAdditonalFields().put(key, value);
        return this;
    }

    public Graylog2Message addField(String key, Object value) {
        getAdditonalFields().put(key, value);
        return this;
    }
    ...
    private void toUTF8(Map<String, String> map) {
